...
struct apple80211_scan_result
{
    ...
    int16_t               unk;  // 0x81 - 0x82
    uint8_t               unk2; // 0x83
    u_int32_t             asr_age;        // (ms) non-zero for cached scan result // 0x84 - 0x87
...
#define APPLE80211_M_SCAN_NETWORK_AVAILABLE    62
