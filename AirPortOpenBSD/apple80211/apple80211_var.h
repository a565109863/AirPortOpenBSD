...
enum apple80211_phymode {
    ...
    APPLE80211_MODE_AUTO               = 1 << 0,        // autoselect
    APPLE80211_MODE_11A                = 1 << 1,        // 5GHz, OFDM
    APPLE80211_MODE_11B                = 1 << 2,        // 2GHz, CCK
    APPLE80211_MODE_11G                = 1 << 3,        // 2GHz, OFDM
    APPLE80211_MODE_11N                = 1 << 4,        // 2GHz/5GHz, OFDM
...
enum apple80211_authtype_upper
{
    ...
    APPLE80211_AUTHTYPE_WPA_8021X       = 1 << 0,    //    WPA
    APPLE80211_AUTHTYPE_WPA_PSK         = 1 << 1,    //    WPA PSK
    APPLE80211_AUTHTYPE_WPA2_8021X      = 1 << 2,    //    WPA2
    ...
    APPLE80211_AUTHTYPE_SHA256_PSK      = 1 << 10,   //    SHA256 PSK
    APPLE80211_AUTHTYPE_SHA256_8021X    = 1 << 11,   //    SHA256 802.1x
    APPLE80211_AUTHTYPE_WPA3_SAE        = 1 << 12,
    APPLE80211_AUTHTYPE_WPA3_FT_SAE     = 1 << 13,
    APPLE80211_AUTHTYPE_WPA3_8021X      = 1 << 14,
    APPLE80211_AUTHTYPE_WPA3_FT_8021X   = 1 << 15,
};
...
struct apple80211_scan_result {
    ...
    uint16_t                    asr_unk; // 0x10 0x11
    uint16_t                    asr_noise; // 0x12 / 0x13
    uint16_t                    asr_snr;  // 0x14 0x15
    uint16_t                    asr_rssi; // 0x16  0x17
    uint16_t                    asr_beacon_int; // 0x18 0x19
    uint16_t                    asr_cap; // 0x1a 0x1b
    struct ether_addr           asr_bssid; // 0x1c 0x1d 0x1e 0x1f 0x20 0x21
    uint8_t                     asr_nrates; // 0x22
    uint8_t                     asr_nr_unk; // 0x23
    uint32_t                    asr_rates[APPLE80211_MAX_RATES]; // 0x24
    uint8_t                     asr_ssid_len; // 0x60
    uint8_t                     asr_ssid[APPLE80211_MAX_SSID_LEN]; // 0x61 ~ 0x80
    uint8_t                     asr_unk2;  // 0x81
    uint16_t                    asr_unk3; // 0x82 0x83
