...
////
//
//IOReturn AirPort_OpenBSD_Class::getWOW_PARAMETERS(OSObject *object, struct apple80211_wow_parameter_data *data)
//{
//    return kIOReturnError;
//}
//
//IOReturn AirPort_OpenBSD_Class::setWOW_PARAMETERS(OSObject *object, struct apple80211_wow_parameter_data *data)
//{
...
////
//
//IOReturn AirPort_OpenBSD_Class::getIE(OSObject *object, struct apple80211_ie_data *data)
//{
//    DebugLog("%s %s Error\n", __FUNCTION__,  INTERFACE_NAME(object));
//    return kIOReturnError;
//}
//
//IOReturn AirPort_OpenBSD_Class::setIE(OSObject *object, struct apple80211_ie_data *data)
//{
...
////
//
//IOReturn AirPort_OpenBSD_Class::getBTCOEX_MODE(OSObject *object, struct apple80211_btc_mode_data *data)
//{
//    if (!data)
//        return kIOReturnError;
...
//}
//
//IOReturn AirPort_OpenBSD_Class::setBTCOEX_MODE(OSObject *object, struct apple80211_btc_mode_data *data)
//{
//    if (!data)
//        return kIOReturnError;
...
////
//
//IOReturn AirPort_OpenBSD_Class::setP2P_SCAN(OSObject *object, struct apple80211_scan_data *data)
//{
...
////
//
//IOReturn AirPort_OpenBSD_Class::setP2P_LISTEN(OSObject *object, struct apple80211_p2p_listen_data *data)
//{
...
////
//
//IOReturn AirPort_OpenBSD_Class::setP2P_GO_CONF(OSObject *object, struct apple80211_p2p_go_conf_data *data)
//{
...
////
//
//IOReturn AirPort_OpenBSD_Class::getROAM_PROFILE(OSObject *object, struct apple80211_roam_profile_band_data *data)
//{
//    if (roamProfile == NULL) {
...
//}
//
//IOReturn AirPort_OpenBSD_Class::setROAM_PROFILE(OSObject *object, struct apple80211_roam_profile_band_data *data)
//{
...
////
//
//IOReturn AirPort_OpenBSD_Class::getBTCOEX_PROFILES(OSObject *object, struct apple80211_btc_profiles_data *data)
//{
//    if (!data || !btcProfile)
//        return kIOReturnError;
...
//}
//
//IOReturn AirPort_OpenBSD_Class::setBTCOEX_PROFILES(OSObject *object, struct apple80211_btc_profiles_data *data)
//{
//    if (!data)
//        return kIOReturnError;
//    if (btcProfile)
...
////
//
//IOReturn AirPort_OpenBSD_Class::getBTCOEX_CONFIG(OSObject *object, struct apple80211_btc_config_data *data)
//{
//    if (!data)
//        return kIOReturnError;
...
//}
//
//IOReturn AirPort_OpenBSD_Class::setBTCOEX_CONFIG(OSObject *object, struct apple80211_btc_config_data *data)
//{
//    if (!data)
//        return kIOReturnError;
